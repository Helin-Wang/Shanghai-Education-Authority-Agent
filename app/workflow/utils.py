...
def extract_examcategory_using_LLM(query: str, llm: ChatOpenAI) -> List[str]:
    ...
    EXAM_CATEGORIES_LIST = ["高考学考", "春季高考", "三校生高考", "艺体类加试", "专科自主招生", "专升本考试", "高中学业考", 
                                 "中职校学业考", "中考中招", "研究生招生考试", "成人高考招生考试", "研考成考", "同等学力人员申请硕士学位外国语水平和学科综合水平全国统一考试",
                                 "自学考试", "证书考试", "全国大学英语四、六级考试（CET）", "全国中小学教师资格考试", "全国英语等级考试（PETS）", "全国计算机等级考试（NCRE）",
                                 "上海市高等学校信息技术水平考试", "普通话水平测试", "上海市高等学校教师资格专业课程考试"]
